 ...
 */
        ...
        String str = "88224646BA", userCodeS;
        ...
        do {
            ...
            char [] usercodeA = userCodeS.toCharArray();
            char [] konamiCode = str.toCharArray();

            for (int i=0; i<=usercodeA.length - konamiCode.length; i++) {
                ...
                if (codeFound) {
                    System.out.println("Código 'Konami' detectado en posición "+i+".");
                }
            }
            if (!codeFound) {
                System.out.println("Código 'Konami' no detectado.");
            }
        } while (!codeFound);
